...
## Situação 01 — Pilar 1 (Autogestão)

**Você cometeu um erro em uma entrega importante que causou retrabalho para o seu time. Como você reage?**

### A) Assumo e proponho solução
*Comunico o erro imediatamente ao time, peço desculpas e proponho uma solução concreta para corrigir o impacto causado.*

- **Indicadores:** I01 Responsabilidade Pessoal (forte) · I02 Gestão Emocional (clara) · I06 Clareza na Expressão (secundária)
- **DISC:** Influência (clara) · Dominância (secundária)
- **Tipo Psicológico:** Guardião (clara) · Idealista (secundária)
- **Motivadores:** Propósito (clara)
- **Estilo Operacional:** Colaborativo (clara) · Executor (secundária)

### B) Corrijo em silêncio
*Resolvo o que precisa ser corrigido sem chamar atenção para o erro, focando em minimizar o impacto o mais rápido possível.*

- **Indicadores:** I19 Qualidade nas Entregas (clara) · I01 Responsabilidade Pessoal (secundária) · I18 Gestão do Tempo (secundária)
- **DISC:** Conformidade (clara) · Estabilidade (clara)
- **Tipo Psicológico:** Artesão (clara) · Guardião (secundária)
- **Motivadores:** Segurança (clara)
- **Estilo Operacional:** Executor (clara)

### C) Contextualizo o problema
*Explico os fatores que contribuíram para o erro e apresento um plano claro para que a situação não se repita.*

- **Indicadores:** I01 Responsabilidade Pessoal (clara) · I16 Planejamento e Organização (clara) · I31 Autocrítica Construtiva (clara) · I05 Clareza de Propósito (secundária)
- **DISC:** Conformidade (forte)
- **Tipo Psicológico:** Estrategista (forte)
- **Motivadores:** Aprendizado (clara)
- **Estilo Operacional:** Analítico (forte) · Planejador (clara)

### D) Reporto e peço orientação
*Reporto a situação ao gestor e peço orientação sobre como proceder para causar o menor impacto possível no time.*

- **Indicadores:** I01 Responsabilidade Pessoal (secundária) · I02 Gestão Emocional (secundária)
- **DISC:** Estabilidade (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Guardião (clara)
- **Motivadores:** Segurança (forte)
- **Estilo Operacional:** Planejador (secundária)
...
- **Indicadores:** I02 Gestão Emocional (forte) · I08 Assertividade (clara) · I29 Abertura ao Feedback (clara) · I06 Clareza na Expressão (secundária)
- **DISC:** Influência (clara) · Dominância (secundária)
- **Tipo Psicológico:** Idealista (secundária) · Estrategista (secundária)
- **Motivadores:** Propósito (secundária) · Reconhecimento (secundária)
- **Estilo Operacional:** Colaborativo (clara)

### B) Aguardo o momento certo
...
- **Indicadores:** I02 Gestão Emocional (forte) · I29 Abertura ao Feedback (clara) · I13 Gestão de Conflitos (clara) · I07 Escuta Ativa (secundária)
- **DISC:** Estabilidade (forte) · Conformidade (secundária)
- **Tipo Psicológico:** Guardião (clara)
- **Motivadores:** Segurança (clara) · Propósito (secundária)
...
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Planejador (clara)

### D) Aceito e avalio depois
*Aceito a crítica publicamente para não criar conflito e avalio internamente se ela procede antes de qualquer reação.*

- **Indicadores:** I02 Gestão Emocional (clara) · I31 Autocrítica Construtiva (clara) · I29 Abertura ao Feedback (secundária)
- **DISC:** Estabilidade (forte) · Conformidade (secundária)
- **Tipo Psicológico:** Guardião (secundária)
- **Motivadores:** Segurança (forte)
- **Estilo Operacional:** Analítico (secundária)
...
- **DISC:** Conformidade (clara) · Dominância (secundária)
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Autonomia (forte)
- **Estilo Operacional:** Planejador (forte)

### B) Avanço nas brechas
*Avanço no projeto nos intervalos entre as tarefas urgentes, aproveitando os momentos de menor demanda do dia.*

- **Indicadores:** I17 Foco e Priorização (secundária) · I18 Gestão do Tempo (secundária) · I04 Disciplina e Consistência (secundária)
- **DISC:** Estabilidade (clara)
- **Tipo Psicológico:** Artesão (clara)
- **Motivadores:** Segurança (secundária)
- **Estilo Operacional:** Executor (clara)

### C) Estruturo formalmente
*Crio um cronograma detalhado e apresento ao gestor para validação antes de começar qualquer execução.*

- **Indicadores:** I16 Planejamento e Organização (forte) · I04 Disciplina e Consistência (clara) · I01 Responsabilidade Pessoal (secundária)
- **DISC:** Conformidade (forte)
- **Tipo Psicológico:** Guardião (clara) · Estrategista (secundária)
- **Motivadores:** Segurança (clara)
...
- **Tipo Psicológico:** Idealista (clara)
- **Motivadores:** Propósito (secundária) · Reconhecimento (secundária)
- **Estilo Operacional:** Colaborativo (forte)

---

## Situação 04 — Pilar 1 (Autogestão)
...
### A) Preparo com profundidade
*Estudo o tema e o público a fundo, preparo uma apresentação clara e estruturada e pratico antes de forma disciplinada.*

- **Indicadores:** I04 Disciplina e Consistência (forte) · I03 Autoconfiança (clara) · I16 Planejamento e Organização (clara) · I06 Clareza na Expressão (clara)
- **DISC:** Conformidade (forte)
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Aprendizado (secundária) · Reconhecimento (secundária)
- **Estilo Operacional:** Planejador (clara) · Analítico (clara)

### B) Foco no que domino
*Me concentro nos pontos que domino com mais segurança e me preparo para responder a perguntas de forma direta e objetiva.*

- **Indicadores:** I03 Autoconfiança (forte) · I08 Assertividade (clara) · I06 Clareza na Expressão (secundária)
- **DISC:** Dominância (forte)
- **Tipo Psicológico:** Artesão (clara)
- **Motivadores:** Reconhecimento (secundária)
- **Estilo Operacional:** Executor (clara)

### C) Busco parceria
*Solicito apoio de um colega mais experiente para realizarmos a apresentação juntos e dividirmos os pontos entre nós.*

- **Indicadores:** I12 Colaboração (forte) · I14 Construção de Confiança (secundária)
- **DISC:** Estabilidade (clara) · Influência (secundária)
- **Tipo Psicológico:** Idealista (secundária) · Guardião (secundária)
- **Motivadores:** Segurança (clara)
- **Estilo Operacional:** Colaborativo (forte)

### D) Ensaio com feedback
*Preparo o material e ensaio com pessoas de confiança para receber críticas e ajustar antes da apresentação real.*

- **Indicadores:** I29 Abertura ao Feedback (forte) · I04 Disciplina e Consistência (clara) · I16 Planejamento e Organização (secundária) · I31 Autocrítica Construtiva (secundária)
- **DISC:** Conformidade (clara) · Estabilidade (secundária)
- **Tipo Psicológico:** Estrategista (secundária) · Idealista (secundária)
- **Motivadores:** Aprendizado (clara)
- **Estilo Operacional:** Planejador (clara) · Colaborativo (secundária)

---

## Situação 05 — Pilar 2 (Comunicação)
...
- **Indicadores:** I10 Comunicação Adaptada (forte) · I06 Clareza na Expressão (forte)
- **DISC:** Influência (clara) · Estabilidade (secundária)
- **Tipo Psicológico:** Idealista (secundária) · Estrategista (secundária)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Planejador (clara) · Colaborativo (secundária)

### B) Segmento a comunicação
*Explico tecnicamente para o time técnico e simplifico para o time operacional em momentos ou formatos separados.*

- **Indicadores:** I10 Comunicação Adaptada (forte) · I06 Clareza na Expressão (clara) · I16 Planejamento e Organização (secundária)
- **DISC:** Conformidade (clara)
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Planejador (clara) · Analítico (secundária)

### C) Documento e disponibilizo
*Envio um documento completo com todos os detalhes e me coloco à disposição para tirar dúvidas individualmente.*

- **Indicadores:** I06 Clareza na Expressão (clara) · I10 Comunicação Adaptada (secundária) · I16 Planejamento e Organização (secundária)
- **DISC:** Conformidade (forte)
- **Tipo Psicológico:** Guardião (clara)
- **Motivadores:** Segurança (secundária)
- **Estilo Operacional:** Analítico (clara) · Planejador (secundária)

### D) Comunico ao vivo
*Reúno o time, faço a explicação oral em uma única sessão coletiva e abro para perguntas em tempo real.*

- **Indicadores:** I06 Clareza na Expressão (clara) · I08 Assertividade (secundária) · I15 Influência Positiva (secundária)
- **DISC:** Influência (forte)
- **Tipo Psicológico:** Artesão (secundária)
- **Motivadores:** Reconhecimento (secundária)
- **Estilo Operacional:** Executor (clara) · Colaborativo (secundária)

---

## Situação 06 — Pilar 2 (Comunicação)
...
### A) Aprofundo com perguntas
*Faço perguntas abertas e específicas para ajudá-lo a explorar o cenário completo antes de sugerir qualquer solução.*

- **Indicadores:** I07 Escuta Ativa (forte) · I11 Empatia (clara) · I09 Feedback Construtivo (secundária)
- **DISC:** Conformidade (secundária) · Influência (secundária)
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Analítico (clara)

### B) Reflito e confirmo
*Ouço atentamente sem interromper e ao final resumo o que entendi, perguntando se capturei tudo corretamente.*

- **Indicadores:** I07 Escuta Ativa (forte) · I11 Empatia (clara) · I06 Clareza na Expressão (secundária) · I10 Comunicação Adaptada (secundária)
- **DISC:** Estabilidade (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Guardião (secundária) · Idealista (secundária)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Analítico (secundária) · Colaborativo (secundária)

### C) Dou espaço total
*Fico em silêncio e deixo o colaborador falar até o fim, sinalizando minha presença apenas com linguagem não-verbal.*

- **Indicadores:** I11 Empatia (forte) · I07 Escuta Ativa (clara)
- **DISC:** Estabilidade (forte)
- **Tipo Psicológico:** Idealista (clara)
- **Motivadores:** Segurança (secundária)
- **Estilo Operacional:** Colaborativo (secundária)

### D) Ofereço minha leitura
*Compartilho minha percepção da situação e pergunto se faz sentido para ele como ponto de partida para a conversa.*

- **Indicadores:** I08 Assertividade (clara) · I06 Clareza na Expressão (clara) · I07 Escuta Ativa (secundária)
- **DISC:** Dominância (clara) · Influência (secundária)
- **Tipo Psicológico:** Estrategista (secundária)
- **Motivadores:** Reconhecimento (secundária)
...
- **DISC:** Estabilidade (forte)
- **Tipo Psicológico:** Guardião (secundária) · Artesão (secundária)
- **Motivadores:** Segurança (clara)
- **Estilo Operacional:** Executor (secundária)
...
- **Indicadores:** I09 Feedback Construtivo (forte) · I08 Assertividade (clara) · I13 Gestão de Conflitos (secundária)
- **DISC:** Dominância (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Estrategista (secundária) · Guardião (secundária)
- **Motivadores:** Propósito (clara)
- **Estilo Operacional:** Executor (secundária) · Colaborativo (secundária)

### B) Abordagem coletiva
*Levanto o tema de forma geral em uma reunião de time sem expor o colega diretamente.*

- **Indicadores:** I09 Feedback Construtivo (secundária) · I06 Clareza na Expressão (secundária)
- **DISC:** Estabilidade (clara) · Influência (secundária)
- **Tipo Psicológico:** Idealista (secundária)
- **Motivadores:** Segurança (clara)
- **Estilo Operacional:** Colaborativo (secundária)
...
- **Indicadores:** I11 Empatia (clara) · I09 Feedback Construtivo (secundária)
- **DISC:** Estabilidade (forte)
- **Tipo Psicológico:** Idealista (secundária)
- **Motivadores:** Segurança (clara)
- **Estilo Operacional:** Colaborativo (secundária)
...
### C) Avanço nas minhas metas
*Aproveito o tempo para antecipar minhas próximas entregas e fortalecer meu próprio planejamento futuro.*

- **Indicadores:** I16 Planejamento e Organização (clara) · I04 Disciplina e Consistência (clara) · I17 Foco e Priorização (secundária)
- **DISC:** Conformidade (clara) · Dominância (secundária)
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Autonomia (clara)
- **Estilo Operacional:** Planejador (clara)

### D) Pergunto diretamente
*Abordo os colegas individualmente, pergunto se precisam de suporte e de que forma específica posso ajudar.*

- **Indicadores:** I12 Colaboração (forte) · I11 Empatia (clara) · I07 Escuta Ativa (secundária)
- **DISC:** Estabilidade (clara) · Influência (secundária)
- **Tipo Psicológico:** Idealista (secundária)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Colaborativo (forte)
...
- **Tipo Psicológico:** Estrategista (clara) · Idealista (secundária)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Colaborativo (clara) · Planejador (secundária)

### B) Enfrento diretamente
*Reúno os dois e trato o problema de forma direta, estabelecendo regras claras de convivência e expectativas para o time.*

- **Indicadores:** I13 Gestão de Conflitos (clara) · I08 Assertividade (clara) · I15 Influência Positiva (secundária)
- **DISC:** Dominância (forte)
- **Tipo Psicológico:** Guardião (secundária) · Artesão (secundária)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Executor (clara)
...
### D) Separo as interações
*Reorganizo as responsabilidades para que os dois não precisem interagir diretamente até que o conflito se resolva.*

- **Indicadores:** I13 Gestão de Conflitos (secundária) · I16 Planejamento e Organização (secundária)
- **DISC:** Conformidade (clara) · Estabilidade (secundária)
- **Tipo Psicológico:** Artesão (secundária) · Guardião (secundária)
- **Motivadores:** Segurança (clara)
- **Estilo Operacional:** Planejador (clara)
...
- **Indicadores:** I11 Empatia (forte) · I14 Construção de Confiança (clara)
- **DISC:** Estabilidade (forte)
- **Tipo Psicológico:** Idealista (clara)
- **Motivadores:** Propósito (clara)
- **Estilo Operacional:** Colaborativo (clara)

### B) Combino um plano juntos
*Converso com ele sobre o impacto no trabalho e construímos juntos um plano realista e respeitoso para o período.*

- **Indicadores:** I11 Empatia (clara) · I12 Colaboração (clara) · I16 Planejamento e Organização (secundária) · I14 Construção de Confiança (secundária)
- **DISC:** Estabilidade (secundária) · Conformidade (secundária)
- **Tipo Psicológico:** Estrategista (secundária) · Idealista (secundária)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Planejador (clara) · Colaborativo (secundária)
...
- **Indicadores:** I11 Empatia (clara) · I12 Colaboração (clara) · I01 Responsabilidade Pessoal (secundária)
- **DISC:** Estabilidade (forte)
- **Tipo Psicológico:** Idealista (secundária) · Guardião (secundária)
- **Motivadores:** Propósito (clara)
- **Estilo Operacional:** Executor (secundária)
...
### A) Crio oportunidades ativamente
*Busco criar espaços para que ele contribua, demonstro confiança no seu potencial e ofereço suporte direto e constante.*

- **Indicadores:** I15 Influência Positiva (forte) · I14 Construção de Confiança (clara) · I25 Inspiração e Motivação (clara) · I23 Desenvolvimento de Pessoas (secundária)
- **DISC:** Influência (clara) · Dominância (secundária)
- **Tipo Psicológico:** Idealista (clara)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Colaborativo (clara)

### B) Observo antes de agir
*Acompanho como ele se sai nas primeiras entregas antes de envolvê-lo em iniciativas de maior visibilidade.*

- **Indicadores:** I14 Construção de Confiança (secundária)
- **DISC:** Conformidade (clara) · Estabilidade (secundária)
- **Tipo Psicológico:** Estrategista (secundária) · Guardião (secundária)
- **Motivadores:** Segurança (clara)
- **Estilo Operacional:** Analítico (clara)

### C) Apresento as expectativas
*Apresento o novo membro ao time e esclareço claramente as expectativas sobre seu papel e sua autonomia.*

- **Indicadores:** I06 Clareza na Expressão (clara) · I14 Construção de Confiança (secundária) · I15 Influência Positiva (secundária) · I10 Comunicação Adaptada (secundária)
- **DISC:** Conformidade (clara) · Dominância (secundária)
- **Tipo Psicológico:** Guardião (clara)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Planejador (clara)
...
### A) Estruturo antes de executar
*Levanto o histórico disponível, mapeio o escopo, estimo o esforço e crio um plano básico antes de qualquer execução.*

- **Indicadores:** I16 Planejamento e Organização (forte) · I21 Visão Estratégica (secundária) · I17 Foco e Priorização (secundária)
- **DISC:** Conformidade (forte)
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Autonomia (secundária)
- **Estilo Operacional:** Planejador (forte) · Analítico (secundária)

### B) Executo e documento
*Começo pela entrega mais crítica e documento o processo conforme avanço para não perder tempo com estrutura prévia.*

- **Indicadores:** I17 Foco e Priorização (clara) · I19 Qualidade nas Entregas (clara) · I18 Gestão do Tempo (clara)
- **DISC:** Dominância (clara)
- **Tipo Psicológico:** Artesão (clara)
...
- **DISC:** Influência (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Idealista (secundária) · Estrategista (secundária)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Colaborativo (forte)
...
- **Indicadores:** I16 Planejamento e Organização (secundária) · I08 Assertividade (secundária)
- **DISC:** Conformidade (clara) · Estabilidade (secundária)
- **Tipo Psicológico:** Guardião (secundária) · Estrategista (secundária)
- **Motivadores:** Segurança (clara)
- **Estilo Operacional:** Planejador (secundária)

---

## Situação 14 — Pilar 4 (Orientação a Resultados)

**Você tem muito mais tarefas do que consegue entregar no dia. Como você decide o que fazer?**

### A) Priorizo com critério
*Classifico por urgência e impacto, comunico o que não entregarei e ofereço alternativas para as partes afetadas.*

- **Indicadores:** I17 Foco e Priorização (forte) · I16 Planejamento e Organização (clara) · I08 Assertividade (secundária) · I18 Gestão do Tempo (secundária)
- **DISC:** Conformidade (clara) · Dominância (secundária)
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Planejador (clara) · Analítico (secundária)

### B) Sigo a ordem de chegada
*Começo pelo que chegou primeiro e avanço pela sequência cronológica das demandas recebidas.*

- **Indicadores:** I18 Gestão do Tempo (secundária)
- **DISC:** Estabilidade (clara)
- **Tipo Psicológico:** Guardião (secundária) · Artesão (secundária)
- **Motivadores:** Segurança (secundária)
- **Estilo Operacional:** Executor (clara)

### C) Valido com o gestor
*Consulto o gestor para validar as prioridades antes de executar qualquer tarefa do dia.*

- **Indicadores:** I17 Foco e Priorização (secundária)
- **DISC:** Estabilidade (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Guardião (clara)
- **Motivadores:** Segurança (clara)
- **Estilo Operacional:** Planejador (secundária)

### D) Foco no que concluo
*Priorizo o que consigo finalizar no dia para não deixar nada pela metade e manter ritmo de entrega.*

- **Indicadores:** I17 Foco e Priorização (clara) · I19 Qualidade nas Entregas (clara) · I18 Gestão do Tempo (secundária)
- **DISC:** Conformidade (secundária) · Dominância (secundária)
- **Tipo Psicológico:** Artesão (clara)
- **Motivadores:** Desafios (secundária)
- **Estilo Operacional:** Executor (clara)
...
### A) Documento e proponho
*Registro os aprendizados, analiso o que deu errado e apresento proativamente uma proposta de próximo passo.*

- **Indicadores:** I20 Resiliência sob Pressão (clara) · I31 Autocrítica Construtiva (clara) · I16 Planejamento e Organização (secundária) · I35 Visão de Futuro (secundária)
- **DISC:** Conformidade (clara) · Dominância (secundária)
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Aprendizado (secundária)
- **Estilo Operacional:** Analítico (clara) · Planejador (secundária)

### B) Processo e recomeço
*Dou tempo para processar o impacto, recupero o foco e recomeço com base nos aprendizados do processo.*

- **Indicadores:** I20 Resiliência sob Pressão (forte) · I02 Gestão Emocional (clara) · I31 Autocrítica Construtiva (secundária)
- **DISC:** Estabilidade (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Artesão (secundária) · Guardião (secundária)
- **Motivadores:** Segurança (secundária)
- **Estilo Operacional:** Executor (secundária)
...
### D) Solicito avaliação externa
*Peço ao gestor uma avaliação externa do que aconteceu antes de tomar qualquer ação ou posicionamento público.*

- **Indicadores:** I20 Resiliência sob Pressão (secundária) · I31 Autocrítica Construtiva (secundária)
- **DISC:** Estabilidade (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Guardião (clara)
- **Motivadores:** Segurança (clara)
- **Estilo Operacional:** Analítico (secundária)
...
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Propósito (clara)
- **Estilo Operacional:** Analítico (secundária) · Planejador (secundária)

### B) Entrego e sinalizo
*Entrego o que está pronto e registro claramente os pontos que precisam de refinamento em um segundo momento.*

- **Indicadores:** I19 Qualidade nas Entregas (secundária) · I06 Clareza na Expressão (secundária) · I18 Gestão do Tempo (secundária)
- **DISC:** Dominância (secundária) · Conformidade (secundária)
- **Tipo Psicológico:** Artesão (secundária)
- **Motivadores:** Desafios (secundária)
- **Estilo Operacional:** Executor (clara)

### C) Otimizo no tempo disponível
*Reviso o que é possível ajustar dentro do prazo e entrego o melhor resultado alcançável com os recursos atuais.*

- **Indicadores:** I19 Qualidade nas Entregas (clara) · I20 Resiliência sob Pressão (clara) · I17 Foco e Priorização (secundária) · I27 Criatividade Prática (secundária)
- **DISC:** Conformidade (secundária) · Estabilidade (secundária)
- **Tipo Psicológico:** Artesão (clara)
- **Motivadores:** Desafios (secundária)
...
- **Indicadores:** I12 Colaboração (clara) · I24 Delegação Eficaz (clara) · I19 Qualidade nas Entregas (secundária)
- **DISC:** Influência (secundária) · Estabilidade (secundária)
- **Tipo Psicológico:** Idealista (secundária)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Colaborativo (forte)
...
## Situação 17 — Pilar 5 (Liderança)

**Você precisa tomar uma decisão importante com informações incompletas e sem tempo para consultar seu gestor. O que faz?**

### A) Decido com o que tenho
*Avalio os dados disponíveis, tomo a decisão mais fundamentada possível e comunico com transparência os critérios usados.*

- **Indicadores:** I22 Tomada de Decisão (forte) · I21 Visão Estratégica (secundária) · I06 Clareza na Expressão (secundária) · I03 Autoconfiança (secundária)
- **DISC:** Dominância (forte)
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Autonomia (clara)
- **Estilo Operacional:** Executor (secundária) · Analítico (secundária)

### B) Busco mais dados rapidamente
*Coleto o máximo de informações possível em tempo reduzido antes de me posicionar formalmente.*

- **Indicadores:** I22 Tomada de Decisão (secundária) · I19 Qualidade nas Entregas (secundária)
- **DISC:** Conformidade (forte)
- **Tipo Psicológico:** Estrategista (secundária)
- **Motivadores:** Desafios (secundária)
- **Estilo Operacional:** Analítico (forte)

### C) Consulto alguém de confiança
*Peço uma segunda opinião rápida de um colega experiente e decido com esse suporte adicional.*

- **Indicadores:** I22 Tomada de Decisão (secundária) · I12 Colaboração (secundária)
- **DISC:** Estabilidade (clara) · Influência (secundária)
- **Tipo Psicológico:** Idealista (secundária) · Guardião (secundária)
- **Motivadores:** Segurança (secundária)
- **Estilo Operacional:** Colaborativo (clara)

### D) Escolho o caminho mais seguro
*Opto pela alternativa mais conservadora para minimizar o risco e ajusto conforme surgem mais informações.*

- **Indicadores:** I22 Tomada de Decisão (secundária) · I20 Resiliência sob Pressão (secundária)
- **DISC:** Estabilidade (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Guardião (clara)
- **Motivadores:** Segurança (forte)
- **Estilo Operacional:** Planejador (secundária)
...
- **Indicadores:** I16 Planejamento e Organização (clara) · I24 Delegação Eficaz (secundária)
- **DISC:** Conformidade (forte)
- **Tipo Psicológico:** Guardião (clara)
- **Motivadores:** Segurança (clara)
- **Estilo Operacional:** Planejador (clara) · Analítico (secundária)

### C) Delego com abertura total
*Explico o que precisa ser feito, digo que estou disponível para dúvidas e não imponho nenhum monitoramento.*

- **Indicadores:** I24 Delegação Eficaz (clara) · I23 Desenvolvimento de Pessoas (secundária)
- **DISC:** Influência (clara) · Estabilidade (secundária)
- **Tipo Psicológico:** Idealista (clara)
- **Motivadores:** Autonomia (clara)
- **Estilo Operacional:** Colaborativo (secundária)

### D) Fracionando a entrega
*Divido a tarefa em partes menores, entrego uma de cada vez e avalio o resultado antes de passar a próxima etapa.*

- **Indicadores:** I24 Delegação Eficaz (clara) · I16 Planejamento e Organização (clara) · I19 Qualidade nas Entregas (secundária)
- **DISC:** Conformidade (clara) · Dominância (secundária)
- **Tipo Psicológico:** Estrategista (secundária) · Guardião (secundária)
- **Motivadores:** Segurança (secundária)
- **Estilo Operacional:** Planejador (forte)
...
### B) Ofereço desafios progressivos
*Crio desafios graduais para que ele desenvolva confiança e consistência através da prática real e do erro seguro.*

- **Indicadores:** I23 Desenvolvimento de Pessoas (forte) · I25 Inspiração e Motivação (clara) · I28 Tolerância à Ambiguidade (secundária)
- **DISC:** Influência (clara) · Dominância (secundária)
- **Tipo Psicológico:** Idealista (clara)
- **Motivadores:** Crescimento (secundária) · Desafios (secundária)
- **Estilo Operacional:** Colaborativo (secundária)

### C) Removo os obstáculos
*Identifico o que está travando a entrega e trabalho para eliminar esses bloqueios antes de cobrar mais resultados.*

- **Indicadores:** I23 Desenvolvimento de Pessoas (clara) · I24 Delegação Eficaz (secundária)
- **DISC:** Estabilidade (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Guardião (secundária) · Estrategista (secundária)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Analítico (secundária) · Executor (secundária)

### D) Tenho a conversa direta
*Tenho uma conversa franca sobre expectativas e alinhamos juntos o que precisa mudar e em que prazo.*

- **Indicadores:** I08 Assertividade (forte) · I09 Feedback Construtivo (clara) · I23 Desenvolvimento de Pessoas (secundária)
- **DISC:** Dominância (forte)
- **Tipo Psicológico:** Guardião (secundária)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Executor (secundária)
...
## Situação 20 — Pilar 5 (Liderança)

**Seu time está visivelmente desmotivado após um período de mudanças e incertezas. Como você age como líder?**

### A) Reconheço e redireciono
*Reúno o time, reconheço o esforço de todos, reforço o propósito do trabalho e apresento o caminho à frente com clareza.*

- **Indicadores:** I25 Inspiração e Motivação (forte) · I05 Clareza de Propósito (clara) · I21 Visão Estratégica (secundária) · I15 Influência Positiva (secundária)
- **DISC:** Influência (clara) · Dominância (secundária)
- **Tipo Psicológico:** Idealista (clara)
- **Motivadores:** Propósito (clara) · Reconhecimento (secundária)
- **Estilo Operacional:** Colaborativo (clara)

### B) Ouço individualmente
*Tenho conversas individuais com cada membro para entender a raiz da desmotivação antes de tomar qualquer ação coletiva.*

- **Indicadores:** I11 Empatia (clara) · I07 Escuta Ativa (clara) · I25 Inspiração e Motivação (secundária)
- **DISC:** Estabilidade (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Idealista (secundária) · Estrategista (secundária)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Colaborativo (secundária) · Analítico (secundária)

### C) Crio um momento de celebração
*Proponho uma pausa estratégica para celebrar as conquistas do time e reconectar o grupo ao propósito do trabalho.*

- **Indicadores:** I25 Inspiração e Motivação (clara) · I15 Influência Positiva (clara) · I05 Clareza de Propósito (secundária)
- **DISC:** Influência (forte)
- **Tipo Psicológico:** Idealista (clara)
- **Motivadores:** Reconhecimento (clara) · Propósito (secundária)
- **Estilo Operacional:** Colaborativo (clara)

### D) Estabeleço metas de curto prazo
*Crio desafios e metas de curto prazo para resgatar o senso de progresso e a sensação concreta de conquista.*

- **Indicadores:** I25 Inspiração e Motivação (clara) · I17 Foco e Priorização (secundária) · I22 Tomada de Decisão (secundária)
- **DISC:** Dominância (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Estrategista (secundária) · Artesão (secundária)
- **Motivadores:** Desafios (clara)
- **Estilo Operacional:** Planejador (clara) · Executor (secundária)
...
- **DISC:** Dominância (clara) · Influência (secundária)
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Crescimento (clara)
- **Estilo Operacional:** Executor (secundária) · Analítico (secundária)

### B) Aguardo mais clareza
*Espero por mais informações antes de me posicionar para ter clareza real sobre o impacto no meu trabalho.*

- **Indicadores:** I28 Tolerância à Ambiguidade (secundária) · I20 Resiliência sob Pressão (secundária)
- **DISC:** Estabilidade (forte) · Conformidade (secundária)
- **Tipo Psicológico:** Guardião (clara)
- **Motivadores:** Segurança (forte)
- **Estilo Operacional:** Planejador (secundária)

### C) Compartilho e proponho
*Comunico minhas preocupações ao gestor e proponho maneiras concretas de facilitar a transição para a área.*

- **Indicadores:** I30 Adaptabilidade (clara) · I08 Assertividade (clara) · I15 Influência Positiva (secundária)
- **DISC:** Dominância (secundária) · Influência (secundária) · Conformidade (secundária)
- **Tipo Psicológico:** Idealista (secundária) · Estrategista (secundária)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Colaborativo (clara)

### D) Foco no que controlo
*Concentro esforço no que está sob meu controle e adapto minha rotina ao que já foi oficialmente comunicado.*

- **Indicadores:** I30 Adaptabilidade (clara) · I20 Resiliência sob Pressão (clara) · I17 Foco e Priorização (secundária)
- **DISC:** Conformidade (clara) · Estabilidade (secundária)
- **Tipo Psicológico:** Artesão (clara)
- **Motivadores:** Segurança (clara)
- **Estilo Operacional:** Executor (clara)
...
- **Indicadores:** I27 Criatividade Prática (forte) · I22 Tomada de Decisão (secundária) · I16 Planejamento e Organização (secundária)
- **DISC:** Dominância (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Desafios (clara)
- **Estilo Operacional:** Analítico (clara) · Planejador (secundária)

### B) Testo em pequena escala
*Desenvolvo e testo uma solução piloto antes de propor formalmente para o time e a liderança.*

- **Indicadores:** I27 Criatividade Prática (forte) · I26 Mentalidade de Crescimento (clara) · I28 Tolerância à Ambiguidade (secundária)
- **DISC:** Conformidade (clara) · Dominância (secundária)
- **Tipo Psicológico:** Estrategista (secundária) · Artesão (secundária)
...
### D) Pesquiso referências
*Investigo como outras equipes ou empresas resolvem o mesmo tipo de problema e trago as referências para o time.*

- **Indicadores:** I32 Busca por Aprendizado (forte) · I27 Criatividade Prática (secundária) · I33 Aplicação do Conhecimento (secundária) · I34 Compartilhamento de Conhecimento (secundária)
- **DISC:** Conformidade (clara)
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Aprendizado (forte)
- **Estilo Operacional:** Analítico (clara)
...
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Autonomia (forte)
- **Estilo Operacional:** Executor (secundária) · Planejador (secundária)

### B) Observo referências
*Acompanho como colegas com responsabilidades similares atuam e uso isso como referência para calibrar meu papel.*

- **Indicadores:** I32 Busca por Aprendizado (clara) · I28 Tolerância à Ambiguidade (secundária)
- **DISC:** Estabilidade (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Guardião (clara)
- **Motivadores:** Aprendizado (secundária)
- **Estilo Operacional:** Analítico (clara)

### C) Valido antes de executar
*Documento minha interpretação do papel e compartilho com o gestor para validar formalmente antes de qualquer ação.*

- **Indicadores:** I28 Tolerância à Ambiguidade (secundária) · I16 Planejamento e Organização (secundária)
- **DISC:** Conformidade (forte)
- **Tipo Psicológico:** Guardião (clara)
- **Motivadores:** Segurança (clara)
- **Estilo Operacional:** Planejador (clara) · Analítico (secundária)
...
- **Indicadores:** I28 Tolerância à Ambiguidade (forte) · I30 Adaptabilidade (clara) · I29 Abertura ao Feedback (secundária) · I27 Criatividade Prática (secundária)
- **DISC:** Dominância (secundária) · Influência (secundária)
- **Tipo Psicológico:** Artesão (clara)
- **Motivadores:** Desafios (secundária)
- **Estilo Operacional:** Executor (clara)
...
## Situação 24 — Pilar 6 (Inovação e Adaptação)

**Você é alocado em um projeto estratégico fora da sua área de especialidade. Como você reage?**

### A) Encaro como oportunidade
*Vejo como oportunidade de crescimento, me dedico a aprender o necessário e assumo o compromisso de entregar.*

- **Indicadores:** I26 Mentalidade de Crescimento (forte) · I32 Busca por Aprendizado (clara) · I28 Tolerância à Ambiguidade (secundária)
- **DISC:** Dominância (clara) · Influência (secundária)
- **Tipo Psicológico:** Idealista (secundária) · Estrategista (secundária)
- **Motivadores:** Crescimento (clara) · Desafios (secundária)
- **Estilo Operacional:** Executor (secundária)

### B) Aprendo com especialistas
*Aceito o desafio e busco ativamente um colega especialista para aprender enquanto contribuo com o que sei.*

- **Indicadores:** I32 Busca por Aprendizado (forte) · I26 Mentalidade de Crescimento (clara) · I12 Colaboração (secundária)
- **DISC:** Influência (secundária) · Estabilidade (secundária)
- **Tipo Psicológico:** Idealista (secundária) · Estrategista (secundária)
- **Motivadores:** Aprendizado (forte)
- **Estilo Operacional:** Colaborativo (clara)

### C) Alinho as lacunas com o gestor
*Tenho uma conversa com o gestor sobre minhas limitações e juntos definimos como cobrir as lacunas do projeto.*

- **Indicadores:** I26 Mentalidade de Crescimento (secundária) · I31 Autocrítica Construtiva (secundária)
- **DISC:** Conformidade (clara) · Estabilidade (secundária)
- **Tipo Psicológico:** Guardião (clara)
- **Motivadores:** Segurança (clara)
- **Estilo Operacional:** Planejador (secundária) · Colaborativo (secundária)

### D) Contribuo no que sei
*Foco no que posso contribuir com segurança dentro do projeto e peço apoio para o que está fora do meu domínio.*

- **Indicadores:** I26 Mentalidade de Crescimento (secundária) · I12 Colaboração (secundária)
- **DISC:** Estabilidade (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Artesão (secundária) · Guardião (secundária)
- **Motivadores:** Segurança (clara)
- **Estilo Operacional:** Executor (secundária)
...
## Situação 25 — Pilar 7 (Desenvolvimento Contínuo)

**Você percebe que sua área está evoluindo rapidamente e seu conhecimento atual está ficando defasado. O que faz?**

### A) Crio um plano de atualização
*Defino um plano pessoal de desenvolvimento com recursos específicos, metas claras e tempo dedicado na agenda.*

- **Indicadores:** I32 Busca por Aprendizado (forte) · I04 Disciplina e Consistência (clara) · I16 Planejamento e Organização (secundária) · I35 Visão de Futuro (secundária)
- **DISC:** Conformidade (clara) · Dominância (secundária)
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Aprendizado (clara) · Autonomia (secundária)
- **Estilo Operacional:** Planejador (forte)

### B) Busco apoio institucional
*Converso com o gestor sobre as necessidades de atualização e busco suporte formal da empresa para me desenvolver.*

- **Indicadores:** I32 Busca por Aprendizado (clara)
- **DISC:** Estabilidade (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Guardião (clara)
- **Motivadores:** Segurança (secundária) · Aprendizado (secundária)
- **Estilo Operacional:** Planejador (secundária) · Colaborativo (secundária)

### C) Aprendo aplicando
*Acompanho referências da área, aplico o conhecimento no trabalho no dia a dia e avalio o que gera impacto real.*

- **Indicadores:** I33 Aplicação do Conhecimento (forte) · I32 Busca por Aprendizado (clara) · I26 Mentalidade de Crescimento (secundária)
- **DISC:** Dominância (secundária) · Conformidade (secundária)
- **Tipo Psicológico:** Artesão (clara)
- **Motivadores:** Aprendizado (clara) · Desafios (secundária)
- **Estilo Operacional:** Executor (clara) · Analítico (secundária)
...
## Situação 26 — Pilar 7 (Desenvolvimento Contínuo)
...
### A) Analiso com honestidade
*Faço uma análise honesta do que contribuiu para isso e defino ações concretas e mensuráveis de melhoria.*

- **Indicadores:** I31 Autocrítica Construtiva (forte) · I26 Mentalidade de Crescimento (secundária) · I16 Planejamento e Organização (secundária)
- **DISC:** Conformidade (clara) · Dominância (secundária)
- **Tipo Psicológico:** Estrategista (clara)
- **Motivadores:** Desafios (secundária) · Crescimento (secundária)
- **Estilo Operacional:** Analítico (clara) · Planejador (secundária)

### B) Alinho com o gestor
*Converso com o gestor para entender se minha percepção está correta e calibrar expectativas para o próximo período.*

- **Indicadores:** I31 Autocrítica Construtiva (secundária) · I07 Escuta Ativa (secundária)
- **DISC:** Estabilidade (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Guardião (clara)
- **Motivadores:** Segurança (secundária)
- **Estilo Operacional:** Colaborativo (secundária)

### C) Foco nos pontos críticos
*Identifico um ou dois pontos prioritários de melhoria e concentro esforço neles antes de ampliar o escopo.*

- **Indicadores:** I31 Autocrítica Construtiva (clara) · I17 Foco e Priorização (clara)
- **DISC:** Conformidade (secundária) · Dominância (secundária)
- **Tipo Psicológico:** Artesão (secundária) · Estrategista (secundária)
- **Motivadores:** Desafios (secundária)
- **Estilo Operacional:** Executor (secundária) · Analítico (secundária)

### D) Busco perspectiva externa
*Peço feedback de pessoas próximas e de confiança para ter uma leitura externa antes de tirar conclusões.*

- **Indicadores:** I31 Autocrítica Construtiva (clara) · I29 Abertura ao Feedback (clara)
- **DISC:** Estabilidade (clara) · Influência (secundária)
- **Tipo Psicológico:** Idealista (secundária)
- **Motivadores:** Aprendizado (secundária)
- **Estilo Operacional:** Colaborativo (clara)
...
### A) Documento e proponho o padrão
*Documento o processo de forma clara, compartilho com o time e proponho que seja adotado como prática padrão.*

- **Indicadores:** I34 Compartilhamento de Conhecimento (forte) · I33 Aplicação do Conhecimento (clara) · I16 Planejamento e Organização (secundária)
- **DISC:** Conformidade (clara) · Dominância (secundária)
- **Tipo Psicológico:** Estrategista (clara) · Guardião (secundária)
- **Motivadores:** Propósito (secundária) · Reconhecimento (secundária)
- **Estilo Operacional:** Planejador (clara) · Analítico (secundária)
...
### C) Compartilho diretamente
*Compartilho a solução com quem mais se beneficiaria dela de forma direta, sem forçar adoção em massa.*

- **Indicadores:** I34 Compartilhamento de Conhecimento (clara) · I11 Empatia (secundária)
- **DISC:** Estabilidade (clara) · Influência (secundária)
- **Tipo Psicológico:** Idealista (secundária)
- **Motivadores:** Propósito (secundária)
- **Estilo Operacional:** Colaborativo (secundária)

### D) Disponibilizo para quem quiser
*Registro a solução internamente e deixo disponível para quem tiver interesse, sem promover ativamente.*

- **Indicadores:** I34 Compartilhamento de Conhecimento (secundária) · I33 Aplicação do Conhecimento (secundária)
- **DISC:** Conformidade (secundária) · Estabilidade (secundária)
- **Tipo Psicológico:** Guardião (secundária) · Artesão (secundária)
- **Motivadores:** Segurança (secundária)
- **Estilo Operacional:** Analítico (secundária)
...
## Situação 28 — Pilar 7 (Desenvolvimento Contínuo)
...
- **Indicadores:** I35 Visão de Futuro (forte) · I21 Visão Estratégica (clara) · I32 Busca por Aprendizado (secundária)
- **DISC:** Conformidade (secundária) · Dominância (secundária)
- **Tipo Psicológico:** Estrategista (forte)
- **Motivadores:** Crescimento (clara)
- **Estilo Operacional:** Planejador (forte)

### B) Evoluo gradualmente
*Mantenho o foco no presente, mas começo a explorar novas habilidades aos poucos, sem grandes rupturas.*

- **Indicadores:** I32 Busca por Aprendizado (clara) · I35 Visão de Futuro (secundária) · I30 Adaptabilidade (secundária)
- **DISC:** Estabilidade (clara) · Conformidade (secundária)
- **Tipo Psicológico:** Artesão (secundária) · Guardião (secundária)
- **Motivadores:** Segurança (secundária) · Aprendizado (secundária)
- **Estilo Operacional:** Executor (secundária)

### C) Busco orientação de referências
*Converso com referências da área para entender as tendências e como me posicionar de forma estratégica.*

- **Indicadores:** I35 Visão de Futuro (clara) · I32 Busca por Aprendizado (clara)
- **DISC:** Influência (secundária) · Conformidade (secundária)
- **Tipo Psicológico:** Estrategista (secundária) · Idealista (secundária)
- **Motivadores:** Aprendizado (clara)
- **Estilo Operacional:** Colaborativo (clara) · Analítico (secundária)

### D) Avalio uma transição
*Considero seriamente se é o momento de uma mudança mais significativa de carreira ou área de atuação.*

- **Indicadores:** I35 Visão de Futuro (clara) · I28 Tolerância à Ambiguidade (clara) · I26 Mentalidade de Crescimento (secundária)
- **DISC:** Dominância (clara)
- **Tipo Psicológico:** Idealista (secundária) · Estrategista (secundária)
- **Motivadores:** Crescimento (secundária) · Desafios (secundária)
- **Estilo Operacional:** Analítico (secundária)
