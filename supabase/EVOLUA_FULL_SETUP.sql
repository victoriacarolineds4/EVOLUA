...
-- >>> migrations/014_response_state_validation.sql
-- ============================================================
...
-- >>> migrations/015_expansion_40_situations.sql
-- ============================================================
-- EVOLUA — Sprint 15 — Expansão de 28 para 40 situações
-- ============================================================
-- Insere as 12 novas situações (S29-S40) aprovadas em
-- SITUACOES_NOVAS_V2_40_PROPOSTA.md (3 rodadas de validação
-- metodológica, 11/09/2026): 12 questions, 48 alternatives,
-- 52 vínculos alternative_indicators.
--
-- Estritamente aditivo — nenhuma linha existente (S01-S28,
-- indicadores, pilares) é alterada. Reversível apagando as
-- linhas com order_index/pillar_number correspondentes (ver
-- backups/qa_cleanup ou reverter via delete where order_index
-- between 29 and 40, cascata cuida de alternatives/links).
-- ============================================================
